...
export default function ManageContacts({ setIsActive, isActive }) {
  const contacts = [
    ...
    { name: 'Jane Smith', email: 'jane@example.com', contactOption: 'Email', query: 'Cake customization' },    { name: 'Jane Smith', email: 'jane@example.com', contactOption: 'Email', query: 'Cake customization' },
